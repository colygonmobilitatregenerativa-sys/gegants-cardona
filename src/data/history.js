export const timelineData = [
  {
    year: '986',
    title: 'Carta de Poblament de Cardona',
    subtitle: 'El bressol comtal de la vila',
    description: 'El comte Borrell II atorga la cèlebre carta de franqueses i poblament als habitants del castell de Cardona, establint el mercat dels dimecres i un règim de llibertat que farà gran la vila.',
    icon: 'castle'
  },
  {
    year: '1834',
    title: 'Naixement dels Gegants del Barri Major',
    subtitle: 'Més d\'un segle i mig de danses',
    description: 'L\'escultor Deogràcies Valls construeix la parella de gegants originals en fusta i cartró pedra per a les festivitats del Barri Major de Cardona, convertint-se en un dels conjunts més antics de Catalunya.',
    icon: 'crown'
  },
  {
    year: '1980',
  ...
  {
    year: '1984',
    title: 'Bateig dels Centenaris: Borrell II i Letgarda',
    subtitle: '150è Aniversari de les figures',
    description: 'Amb motiu del seu segle i mig d\'història, els gegants del Barri Major són solemnement batejats amb els noms històrics del comte Borrell II i la seva muller Letgarda.',
    icon: 'scroll'
  },
  {
    year: '2019',
    title: 'Renovació escultòrica per Toni Mujal',
    subtitle: 'Artesania viva cardonina',
    description: 'El prestigiós mestre geganter i escultor cardoní Toni Mujal realitza les noves figures del Barri Nou, millorant-ne l\'ergonomia per als portadors i mantenint-ne l\'ànima llegendària.',
    icon: 'sparkles'
  }
];

export const minyonaLegend = {
